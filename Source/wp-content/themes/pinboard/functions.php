...
function pinboard_theme_setup() {
	...
	add_image_size( 'product-thumb', 393, 205, 1 );
...
function pinboard_register_styles() {
	...
	wp_register_style( 'owl.carousel.css', get_template_directory_uri() . '/styles/owl.carousel.css', false, null );
	wp_register_style( 'owl.theme', get_template_directory_uri() . '/styles/owl.theme.css', false, null );
	wp_register_style( 'owl.transitions', get_template_directory_uri() . '/styles/owl.transitions.css', false, null );
	wp_register_style( 'custom', get_template_directory_uri() . '/styles/custom.css', false, null );
}
endif;
...
function pinboard_register_scripts() {
	...
	wp_register_script( 'owl_carousel_min', get_template_directory_uri() . '/scripts/owl.carousel.min.js', array( 'jquery' ), null );
	wp_register_script( 'custom', get_template_directory_uri() . '/scripts/custom.js', array( 'jquery' ), null );
}
endif;
